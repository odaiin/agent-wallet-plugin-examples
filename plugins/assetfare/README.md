...
two-command handoff pinned to `assetfare-mcp@1.6.1`. Because this plugin removes
...
The 1.6.1 session capability preserves strict verification context so every
