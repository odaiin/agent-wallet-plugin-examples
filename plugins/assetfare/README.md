...
two-command handoff pinned to `assetfare-mcp@1.3.6`. Because this plugin removes
...
The 1.3.6 session capability preserves strict verification context so every
