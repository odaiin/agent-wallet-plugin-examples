...
two-command handoff pinned to `assetfare-mcp@1.3.5`. Because this plugin removes
...
The 1.3.5 session capability preserves strict verification context so every
