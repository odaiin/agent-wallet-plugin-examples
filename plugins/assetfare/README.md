...
two-command handoff pinned to `assetfare-mcp@1.5.2`. Because this plugin removes
...
The 1.5.2 session capability preserves strict verification context so every
