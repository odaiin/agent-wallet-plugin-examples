...
two-command handoff pinned to `assetfare-mcp@1.6.0`. Because this plugin removes
...
The 1.6.0 session capability preserves strict verification context so every
