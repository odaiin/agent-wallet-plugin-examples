...
test("quote uses one exact POST body, strips workflow handoffs, and gives fresh all-quotes guidance", async () => {
  ...
  assert.equal(result.guidance.caller_owned_continuation.package_version, "1.6.0");
  ...
  assert.deepEqual(result.guidance.caller_owned_continuation.quote_command.args, [
    "--yes", "--package=assetfare-mcp@1.6.0", "assetfare-route-eval", "--amount", "1000",
  ...
  assert.deepEqual(result.guidance.caller_owned_continuation.action_lifetime, {
